...
//  MySwiftUIApp
//
//  Created by Fedor Sychev on 01.09.2021.
//
...
//                )
            ...
            CardView()
                .frame(width: showCard ? 375 : 340.0)
                .frame(height: 220)
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        ContentView()
//            .previewLayout(.fixed(width: 340, height: 667))
    }
}
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificate is proof that Sychev Fedor has achieved the UI Design course with approval from a Design+Code instructor.")
            ...
            HStack(spacing: 20) {
                RingView(color1: #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1), color2: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), width: 88, height: 88, percent: 78, show: $show)
                    .animation(.easeInOut.delay(0.3), value: true)
