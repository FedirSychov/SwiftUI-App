...
func getCardWith(bounds: GeometryProxy) -> CGFloat {
...
func getCardBorderRadius(bounds: GeometryProxy) -> CGFloat {
...
struct CourseView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            .clipShape(RoundedRectangle(cornerRadius: show ? getCardBorderRadius(bounds: bounds) : 30, style: .continuous))
